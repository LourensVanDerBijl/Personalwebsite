    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="modal-text">
          ...
          <p><strong class="field-heading">Platform:</strong> {{ item.platform }}</p>
          <p><strong class="field-heading">Category:</strong> {{ item.type }}</p>
          <p><strong class="field-heading">Issued:</strong> {{ item.completedDate }}</p>
        </div>

        <!-- Scrollable certificate image -->
        <div v-if="item.url" class="modal-image-scroll">
...
.field-heading {
  color: #ff4d00; /* orange headings */
}

.modal-image-scroll {
  flex: 1;
  overflow-y: auto; /* scrollable certificate */
...
/* Orange scrollbar for certificate */
